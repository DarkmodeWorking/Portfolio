  ...
  return (
    <div className='fixed top-12 right-6 mx-auto flex flex-col gap-2.5 items-end z-50 md:right-auto md:left-1/2 md:-translate-x-1/2'>
			...
			>
				...
				<img className='block dark:block' src='/menu_icon_dark.svg' alt='menu icon' />
			</button>
			...
			>
				<ul className='flex flex-col items-center gap-4 text-lg font-normal md:flex-row'>
					<li>
						<div 
							className={cn('rounded p-1 duration-300 ease-in-out', { 'bg-primary text-white': activeSection === 'home', })}
							onClick={() => {
								setActiveSection('home')
					...
					<li>
						<div 
							className={cn('rounded p-1 duration-300 ease-in-out', { 'bg-primary text-white': activeSection === 'skills', })}
							onClick={() => {
					...
					<li>
						<div 
							className={cn('rounded p-1 duration-300 ease-in-out', { 'bg-primary text-white': activeSection === 'projects', })}
							onClick={() => {
					...
					<li>
						<div 
							className={cn('rounded p-1 duration-300 ease-in-out', { 'bg-primary text-white': activeSection === 'contact', })}
							onClick={() => {
