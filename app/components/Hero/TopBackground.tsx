      ...
      <div className='absolute w-full max-w-[360px] md:max-w-screen-lg h-[285px] md:h-[656px] top-[188px] md:top-11 left-1/2 -translate-x-1/2 md:overflow-x-hidden z-10'>
        <div className='w-full h-full relative'>
          ...
          <div className='hidden md:circle-icon md:top-[368px] md:left-[965px]'>
            <Image src='/stackoverflow_icon.svg' alt='Stack Icon' width={23} height={23} />
          </div>
        </div>
      </div>
      <img src='/top_highlight.svg' alt='Top Darkmode background highlight' width={809} height={877} className='absolute top-[-515px] hidden dark:md:block left-1/2 -translate-x-1/2' />
      <img src='/top_highlight.svg' alt='Top Darkmode background highlight (Mobile)' width={429} height={465} className='absolute top-[-229px] hidden dark:block dark:md:hidden left-1/2 -translate-x-1/2' />
